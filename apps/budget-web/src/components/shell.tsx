...
/** Send the user to Outegro ID, asking it to return to the current budget page after sign-in. */
function goToLogin() {
  const next = typeof window !== "undefined" ? window.location.href : "https://budget.outegro.com/";
