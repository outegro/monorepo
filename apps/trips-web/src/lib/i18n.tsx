...
const en = {
  ...
  "queue.pending": "Reading the reel and searching…",
  "queue.deleteConfirm": "Delete this reel?",
  "queue.skip": "Skip",
  ...
  "places.fromReels": "From {n} reel(s)",
...
const ru = {
  ...
  "queue.pending": "Читаю рилс и ищу место…",
  "queue.deleteConfirm": "Удалить этот рилс?",
  ...
  "places.open": "Kakao",
  "places.count": "Мест: {n}",
  "places.deleteConfirm": "Удалить это место?",
  "places.fromReels": "Из рилсов: {n}",
